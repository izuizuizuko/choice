ActiveAdmin.register Hordeolum do  form do |f|
  f.inputs '商品' do
    ...
    f.input :advice3
    f.input :picture
    f.input :hordeolum_image, :as => :file
...
permit_params :name, :company, :rank, :point, :pit1, :pit2, :pit3, :advice1, :advice2, :advice3, :picture, hordeolums_images_attribut: [:id, :image, :reference, :_destroy]
